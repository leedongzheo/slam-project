...
class PreprocessingLayerNode(Node):
    ...
    def __init__(self) -> None:
        ...
        self.declare_parameter('laser_min_height', -999.0)
        self.declare_parameter('laser_max_height', 999.0)
        #self.declare_parameter('laser_min_height', -0.2)
        #self.declare_parameter('laser_max_height', 0.1)
        self.declare_parameter('laser_angle_min', -3.14)
        self.declare_parameter('laser_angle_max', 3.14)
        ...
        self.declare_parameter('laser_range_max', 9999.0)
